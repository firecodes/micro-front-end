<template>
  <div class="spot_campaign_how_tile_list" ref="TileListComponent">
    <div class="left">
      <div class="img ipad">
        ...
        <div class="content">
          <el-scrollbar style="height:100%; width: 100%">
            ...
            <div class="line"></div>
            <p v-html="check_arr.length ? check_arr[0].content : table_placeholder" />
          </el-scrollbar>
        </div>
      </div>
    </div>
