    ...
    methods: {
      init() {
        ...
        const setting =
        {
          ...
          plugins: ['image', 'autolink', 'fullscreen', 'help', 'insertdatetime', 'preview', 'link', 'table'],
          toolbar: [
...
.editorComp {
  ...
  /deep/ .mce-container-body .mce-panel .mce-stack-layout .mce-last .mce-container-body {
