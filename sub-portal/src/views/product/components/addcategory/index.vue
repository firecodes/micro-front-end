<template>
  <div class="add-category">
    <el-dialog
      :title="$t('configuration.fc_product_add_category_title')"
    ...
    >
      ...
      >
        <el-table-column
          prop="name"
          :label="
            $t('configuration.fc_product_add_category_table_category_label')
          "
        >
            ...
            <template v-if="scope.row.type === 'addOrEdit'">
              <div class="add">
                <el-input
                  ...
                  "
                  maxlength="32"
                  v-model="categoryList[scope.$index].name"
                  @keyup.native="
        ...
        <el-table-column
          prop="operation"
          :label="
            $t('configuration.fc_product_add_category_table_operation_label')
          "
          width="200px"
        >
          <template slot-scope="scope">
