  ...
  <div class="advanced-query" ref="advanced-query">
    <el-form ref="form" :rules="rules"  :model="form" label-width="210px">
      <el-row class="list">
        <!-- member code -->
        <el-col>
          <el-form-item :label="$t('member.fc_member_view_member_code_label')" prop="member_code">
            <el-input type="text" v-model="form.member_code" class="width-300" max="32" />
          </el-form-item>
        </el-col>
        <!-- country/province/city -->
        <el-col>
          <el-form-item :label="$t('member.fc_member_view_country_label')" prop="cpc">
            <select-country-province-city @handleSelectCity="handleSelectCity" :value1="form.cpc" class="width-300"/>
          </el-form-item>
        </el-col>
        <!-- first name -->
        <el-col>
          <el-form-item :label="$t('member.fc_member_view_first_name_label')" prop="first_name">
        ...
        <!-- last name -->
        <el-col>
          <el-form-item :label="$t('member.fc_member_view_last_name_label')" prop="last_name">
            <el-input type="text" v-model="form.last_name" class="width-300" />
          </el-form-item>
        </el-col>
        <!-- Registration channel -->
        <el-col>
          <el-form-item :label="$t('member.fc_member_view_channel_label')" prop="register_channel_code">
        ...
        <el-col>
          <el-form-item :label="$t('member.fc_member_view_gender_label')" prop="gender">
            <el-select v-model="form.gender" filterable clearable :placeholder="handleGlobalI18n('member', 'please_select')" class="width-300">
              <el-option :label="$t('member.fc_member_view_gender_menu_1st_label')" :value="parseInt(1)"></el-option>
              <el-option :label="$t('member.fc_member_view_gender_menu_2nd_label')" :value="parseInt(2)"></el-option>
              <el-option :label="$t('member.fc_member_view_gender_menu_3rd_label')" :value="parseInt(0)"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <!-- registration store name -->
        <el-col>
          <el-form-item :label="$t('member.fc_member_view_store_label')" prop="register_store_code">
            <registration-name :list="list" :value="form.registration1" @registration_name = "selectRegistration" class="width-300" />
          </el-form-item>
        </el-col>
        <!-- Registration staff -->
        <el-col>
          <el-form-item :label="$t('member.fc_member_view_staff_label')" prop="register_employee_code">
        ...
        <!--birthday period-->
        <el-col>
          <el-form-item :label="$t('member.fc_member_view_birthday_label')" prop="birthday_form">
            <date-range @valueDate = "valueDateBirthday" :value="birthday_date" class="width-300" />
          </el-form-item>
        </el-col>
        <!-- registration store code -->
        <el-col >
          <el-form-item :label="$t('member.fc_member_view_store_code_label')" prop="register_store_code">
            <el-input type="text" v-model="form.register_store_code" class="width-300" />
          </el-form-item>
        </el-col>
        <!-- mobile -->
        <el-col>
          <el-form-item :label="$t('member.fc_member_view_mobile_label')" prop="mobile">
            <el-input type="text" v-model="form.mobile" class="width-300" />
          </el-form-item>
        </el-col>
        <!-- preferred store name -->
        <el-col>
          <el-form-item :label="$t('member.fc_member_view_preferred_store_label')">
        ...
        <el-col class="button" type="flex" justify="right">
          <el-form-item>
            <div>
              <el-button @click="resetForm1" icon="el-icon-refresh">{{$t('member.fc_member_view_btn_reset_label')}}</el-button>
              <el-button type="primary" @click="search" icon="el-icon-search">{{$t('member.fc_member_view_btn_search_label')}}</el-button>
              <el-button :loading="downloadLoading" @click="handleDownload" icon="el-icon-download" type="primary" v-allow="'member_view_search_export'">{{$t('member.fc_member_view_btn_export_label')}}</el-button>
            </div>
          </el-form-item>
        </el-col>
      </el-row>
  ...
  export default {
    ...
    methods: {
      ...
      resetForm1() {
        ...
        this.form.additional_code = ''
        this.form.additional_value = ''
      }
    },
    watch: {
      birthday_date() {
