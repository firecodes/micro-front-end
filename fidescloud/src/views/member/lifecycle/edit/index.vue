<template>
  <div class="edit-add-detail-copy-gift new-theme-css addNewTagPage" v-loading="detail_loading">
    ...
    <div class="contain" :class="{'detail-contain' : query.type === 'detail'}">
      <ed-header-title :title="'Edit a lifecycle stage'" />
      <el-form ref="gift" label-position="left" :model="form" :rules="rules"  label-width="300px">
        <div class="content">
          <div class="info">
              <!--Lifecycle stage-->
              <el-form-item label="Lifecycle stage:" class="dotted-line" prop="gift_code" ref="gift_code">
                <template>
                  <p class="color-333">Loyal members</p>
                </template>
              </el-form-item>
              <!--  -->
              <!--Conditions:-->
              <el-form-item label="Conditions:" prop="gift_name" class="no-line">
                <template>
                  <p class="" style="color: #2777FF;"><i class="el-icon-info" style="color:#2777FF;marginRight:10px;fontSize:14px;"></i>Tag members according to intersection of condition set.</p>
                </template>
              </el-form-item>
              <!-- General-->
              <el-form-item label="General:" class="solid-line" prop="unit_price">
                <el-checkbox class="">Registration date</el-checkbox>
              </el-form-item>
              <!-- Transaction -->
              <el-form-item label="Transaction:" label-position='top' class="no-line transaction" prop="purchased_price">
                <div class="transaction-div">
                  <el-checkbox class="">Last transaction date</el-checkbox>
                  <el-select v-model="form.gift_category_code" placeholder="Please select" clearable filterable style="width: 235px;">
                ...
                <div class="transaction-div">
                  ...
                  <el-input class="transaction-input margin-left-20" /> <label class="label-46" for="">Times</label> - <el-input class="transaction-input" /> <label for="">Times</label> <span style="color: #2777FF;"><i class="el-icon-info" style="color:#2777FF;marginRight:10px;marginLeft:10px;" /><span>zero means no transaction records.</span></span>
                </div>
                <div class="transaction-div">
                  ...
                  <el-input class="transaction-input margin-left-20" /> <label class="label-46" for="">USD</label> - <el-input class="transaction-input" /> <label for="">USD</label>
                </div>
                <div class="transaction-div">
                ...
                <div class="transaction-div">
                  ...
                  <el-input class="transaction-input margin-left-20" /> <label class="label-46" for="">Pieces</label> - <el-input class="transaction-input" /> <label for="">Pieces</label>
                </div>
              </el-form-item>
          </div>
        </div>
...
.addNewTagPage {
  ...
  .edit-add-detail-copy-gift {
    ...
    .el-form-item.dotted-line {
      border-bottom: 1px dashed #ccc;
      padding: 0 20px;
    }
    .el-form-item.solid-line {
      border-bottom: 1px solid #e6e6e6;
      margin: 0 0 70px 20px;
    }
    .el-form-item.no-line {
      padding: 0 20px;
    }
    .el-form-item.transaction {
      padding-top: 22px;
      padding-bottom: 15px;
    }
    .el-select{
