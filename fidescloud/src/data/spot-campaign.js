export const when_options = [
  { value: 2, label: 'fc_campaign_spot_create_when_timing_menu1_label' },
  { value: 1, label: 'fc_campaign_spot_create_when_timing_menu2_label' }
]

export const who_options = [
  { value: 4, label: 'fc_campaign_spot_create_who_audience_menu1_label' },
  { value: 1, label: 'fc_campaign_spot_create_who_audience_menu2_label' },
  { value: 2, label: 'fc_campaign_spot_create_who_audience_menu3_label' },
  { value: 3, label: 'fc_campaign_spot_create_who_audience_menu4_label' }
]
    ...
    criteria_field: [
      {
        ...
        criteria_field_name: 'postal code',
    ...
    criteria_field: [
      {
        ...
        criteria_field_name: 'purchased date',
        criteria_field_code: 'purchased_date'
      }, {
        ...
        criteria_field_name: 'purchased store',
...
export const who_tagged_member = [
  {
    ...
    list: [
      { segmentation_value_name: 'no purchase', segmentation_value_code: 'no_purchase' },
      { segmentation_value_name: 'only 1 time purchase', segmentation_value_code: 'only_1_time_purchase' },
      { segmentation_value_name: 'purchase more than 2 times', segmentation_value_code: 'purchase_more_than_2_times' }
    ]
  }, {
    ...
    list: [
      ...
      { segmentation_value_name: '1 times', segmentation_value_code: '1_times' },
      { segmentation_value_name: '2 times', segmentation_value_code: '2_times' },
      { segmentation_value_name: '3-6 times', segmentation_value_code: '3_6_times' },
      { segmentation_value_name: 'above 6 times', segmentation_value_code: 'above_6_times' }
    ]
  }, {
    segmentation_type_code: 'lastest_purchase_date',
    segmentation_type_name: 'lastest purchase date',
    list: [
      { segmentation_value_name: 'with 1 month', segmentation_value_code: 'within_1_month' },
      { segmentation_value_name: '1-3 month', segmentation_value_code: '1_3_month' },
      { segmentation_value_name: '4-6 month', segmentation_value_code: '4_6_month' },
      { segmentation_value_name: '6-12 month', segmentation_value_code: '6_12_month' },
      { segmentation_value_name: 'more than 1 year', segmentation_value_code: 'more_than_1_year' }
    ]
  }, {
    ...
    list: [
      ...
      { segmentation_value_name: 'discount', segmentation_value_code: 'discount' },
