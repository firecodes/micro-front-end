      ...
      <div class="list-type">
        <div v-loading="listLoading">
          <el-table :data="tableData" @sort-change="sortChange" @selection-change="handleSelectionChange" size="medium"  highlight-current-row :empty-text="handleGlobalI18n('system', 'no_data')">
            ...
            <el-table-column prop="Campaign name" min-width="90" align="center" label="Campaign Name" width="280">
            ...
            <el-table-column label="Campaign date" prop="unit_price" align="center" width="280">
              <template slot-scope="scope">
