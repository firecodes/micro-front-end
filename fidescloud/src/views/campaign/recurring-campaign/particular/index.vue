      ...
      <el-scrollbar style="height:100%;">
        <div>
          ...
          <section class="campaign_particular__content">
            <keep-alive>
              <component :campaign_wizard_id="query.id" :form_data="form" :is="handleComponent()" :ref="handleComponent()"></component>
            </keep-alive>
          </section>
        </div>
      </el-scrollbar>
