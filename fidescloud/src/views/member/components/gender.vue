<template>
  <div class="progressComponent">
    <div class="gender-box">
      <div id="progress"></div>
      <img class="nanren" :src="require('@/assets/images/nanren.png')" alt="">
      <span class="male-span">120%</span>
      <img class="nvrentouxiang" :src="require('@/assets/images/nvrentouxiang.png')" alt="">
      <span class="female-span">60%</span>
    </div>
  </div>
</template>
...
export default {
  name: 'Gender',
  mounted() {
    const app = echarts.init(document.getElementById('progress'))
    var option = {
      backgroundColor: '#fff',
      padding: [10],
      title: {
