        ...
        <ed-form>
          <el-form :model="form" :rules="rules" label-width="80px" ref="form">
            ...
            <el-form-item :label="$t('campaign.fc_campaign_spot_how_edm_add_subject_label')" prop="subject">
              <el-input maxlength="64" v-model="form.subject" />
            </el-form-item>
            <div class="detail">
              <div class="left">
                <!--Variable-->
  ...
  export default {
    ...
    watch: {
      language() {
        this.rules = {
          subject: [
            { required: true, message: this.$t('member.fc_field_input_empty_tips'), trigger: ['blur'] }
          ],
          content: [
            { required: true, message: this.$t('member.fc_field_input_empty_tips'), trigger: ['blur', 'change'] }
          ]
        }
      },
      dialog_show_state() {
