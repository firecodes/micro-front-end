      ...
      init() {
        ...
        const setting =
          ...
          `,
            ...
            'toolbar2': ' fontsizeselect | forecolor backcolor | fontselect bold italic underline strikethrough | alignleft aligncenter alignright alignjustify | outdent indent | removeformat emoticons fullscreen help insertdatetime custom-preview', // 工具栏2
            // 图片上传
            images_upload_handler: function(blobInfo, success, failure) {
              ...
              function uploadPic() { // 发送请求
                ...
                uploadImage(formData).then(res => {
                  ...
                  tinymce.execCommand('mceInsertContent', false, '<img src=' + json + '>')
                }).catch(() => {
                  failure('fail to upload')
