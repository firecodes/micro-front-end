...
<script>
  import {
    reima_allOrderInfo,
    reima_approveOrderInfo,
    reima_exportallOrderInfo
  } from '@/api/order'
  ...
  export default {
    ...
    methods: {
      ...
      exportCouponList() {
        this.loading = true
        reima_exportallOrderInfo(this.listQuery).then(res => {
      ...
      getCouponList() {
        ...
        this.loading = true
        reima_allOrderInfo(this.listQuery).then(res => {
          console.log(res)
      ...
      handleEdit(index, row, active) {
        ...
        if (active === 'active') {
          ...
          this.loading = true
          reima_approveOrderInfo(subOrder).then(res => {
            console.log(res)
            this.getCouponList()
            this.loading = false
          }).catch(res => {
