<template>
  <div class="analysisInfoComponent">
    ...
    <div class="tier-box">
      <span>Tier</span>
      <draw-pie :content={...tierdata} :colors="tierdata.colors"></draw-pie>
    </div>
    <div class="skus-box">
...
import DrawPie from '../../rfm/PieChart'
import Scatter from '../../components/goods'
export default {
  components: {
    Gender,
    DrawShape,
...
.analysisInfoComponent {
  ...
  .gender-box, .age-box, .territory-box, .tier-box, .skus-box, .campaigns-box, .purchase-box, .average-box, .averages-box {
    width: 500px;
    height: 320px;
    margin-bottom: 20px;
  }
