var host = "https://fctest.accuat.com";
...
export const member = {
  ...
  queryMemberGroupList:
    host + "/generic/member/memberGroup/queryMemberGroupList",
  queryAllTags: host + "/generic/member//member/tag/all",
  queryMemberNumAndDetailByTag:
    host + "/generic/member/member/tag/queryMemberNumAndDetailByTag",
  quickQueryMemberNumByGroup:
    host + "/generic/member/memberGroup/quickQueryMemberNumByGroup"
};
...
export const campaign = {
  ...
  getCommunicationChannelTypeList:
    "/communicationChannelType/getCommunicationChannelTypeList",
  getReservedFieldListByCommunicationChannelType:
    "/communicationReservedField/getReservedFieldListByCommunicationChannelType",
  addOrUpdateCampaignCommunication:
    "/campaign/addOrUpdateCampaignCommunication",
  getTemplateListByCommunicationChannelType:
    "/communicationTemplate/getTemplateListByCommunicationChannelType",
  addOrUpdateCommunicationChannelTemplate:
    "/campaign/addOrUpdateCommunicationChannelTemplate",
  ...
  sendTesterGroupCommunication:
    "/communicationTemplate/sendTesterGroupCommunication",
...
export const report = {
  ...
  associationReport:
    host + "/fides/customization/v1/brotzeit/associationReport", // 只针对brotzeit
  businessTransactionReport:
    host + "/openapi/dw/fc/report/businessTransactionReport",
  memberTypeTransactionReport:
    host + "/openapi/dw/fc/report/memberTypeTransactionReport",
  memberTierSalesTransReport:
    host + "/openapi/dw/fc/report/memberTierSalesTransReport",
...
export const redemption = {
  ...
  memberRedeemOrderByTotalPointAndCouponCodes:
    "/redemption/memberRedeemOrderByTotalPointAndCouponCodes"
};
...
export const lifecycleStudio = {
  ...
  getLifeCycleTemplateListByType:
    "/communicationTemplate/getLifeCycleTemplateListByType",
  cancelLifecycleCampaign: "/campaign/cancelLifecycleCampaign"
};
